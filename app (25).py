...
# ✅ FIXED PROFILE PICTURE UPLOAD ROUTE - SIGNATURE ERROR FIXED
@app.route('/upload-profile-pic', methods=['POST'])
@login_required
def upload_profile_pic():
    """Upload profile picture to Cloudinary - FIXED SIGNATURE ERROR"""
...
def register():
    ...
    if request.method == 'POST':
        ...
        # ✅ FIXED: CLOUDINARY PROFILE PICTURE HANDLING - SIGNATURE ERROR FIXED
        ...
        if 'profile_pic' in request.files:
            ...
            if file and file.filename and allowed_file(file.filename):
                try:
                    ...
                    # ✅ FIXED: Use transformation string
    ...
    try:
        ...
        for user in users:
            ...
            if os.path.exists(filepath):
                ...
                print(f"⚠️  File not found for user {user_id}, set to default")
        
        # Also update users with null or empty profile pics
        cur.execute("""
            UPDATE users 
            SET profile_pic = %s 
        ...
        if default_updated > 0:
            print(f"🔄 Updated {default_updated} users with default avatar")
        ...
        print(f"   🔄 Set to default: {default_updated}")
        print("="*50)
