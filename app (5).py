        ...
        try:
            with get_db_connection() as conn:
                with conn.cursor() as cur:
                    ...
                    # Set session - PROFILE PIC को CORRECT तरीके से SET करो
                    session['user_id'] = user_id
                    session['full_name'] = full_name
                    session['phone'] = phone
                    session['email'] = email
                    session['location'] = location
                    session['profile_pic'] = profile_pic  # ✅ यहाँ profile_pic variable use करो
            ...
            with get_db_connection() as conn:
                with conn.cursor() as cur:
                    ...
                    if user and check_password_hash(user['password'], password):
                        ...
                        session['profile_pic'] = user['profile_pic']  # ✅ Profile pic को database से लो
